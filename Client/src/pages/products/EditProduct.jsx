    ...
    try {
      const [productRes, ratesRes] = await Promise.all([
        ...
        setProduct({
          ...
          barcode: productRes.data.barcode || '',
          category: productRes.data.category,
          weight: productRes.data.weight,
        makingCharge: productRes.data.makingCharge,
        wastage: productRes.data.wastage,
        stock: productRes.data.stock,
        minStock: productRes.data.minStock,
        gst: productRes.data.gst,
        customRate: productRes.data.customRate || ''
      });
